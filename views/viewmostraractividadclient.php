                                    ...
                                    <div class="border-top mt-4 pt-4">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <form id="addcoment" method="post">
                                                <div class="form-row">
                                                    <input type="hidden" name="id_actividad" <?php echo 'value="'.$dato["id"].'"'; ?> >
                                                    <div class="control-group col-sm-10">
                                                        <input type="text" class="form-control p-4" name="Descripcion" placeholder="Hola..."
                                                    ...
                                                    <div class="control-group col-sm-6 text-center">
                                                        <button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton">Publicar</button>
                                                    </div>
                                                </div>    
                                            </form>
                                        <?php
