    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <form action="index.php?accion=altainvestigador"  method="post" enctype="multipart/form-data">
                ...
                <input type="file" name="imagen">
                    <div class="text-center">
                        <button class="btn btn-primary py-3 px-4" type="submit" id="sendMessageButton">CREAR INVESTIGADOR</button>
                    </div>
                </form>
            </div>
        </div>
