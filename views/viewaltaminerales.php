...
<?php include ('controller/header.php'); ?>
    ...
    <h2 class="mb-4 text-center">Alta Mineral</h2>    

<div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
           <form action="index.php?accion=altamineral"  method="post" enctype="multipart/form-data">
    ...
    <div class="control-group">
        ...
        <input type="text" class="form-control p-4" name="formula" placeholder="formula"
            required="required" data-validation-required-message="Por favor escriba el formula" />
        <p class="help-block text-danger"></p>
    </div>
    <div class="control-group">
        <label for="">CLASE</label>
        <input type="text" class="form-control p-4" name="clase" placeholder="clase"
            required="required" data-validation-required-message="Por favor escriba el clase" />
        <p class="help-block text-danger"></p>
    </div>
    <div class="control-group">
        <label for="">SISTEMA CRISTALINO</label>
        <input type="text" class="form-control p-4" name="sistema_cristalino" placeholder="sistema_cristalino"
            required="required" data-validation-required-message="Por favor escriba el sistema_cristalino" />
        <p class="help-block text-danger"></p>
    </div>
    <div class="control-group">
        <label for="">HABITO</label>
        <input type="text" class="form-control p-4" name="habito" placeholder="habito"
    ...
    <div class="text-center">
        <button class="btn btn-primary py-3 px-4" type="submit" id="sendMessageButton">CREAR MINERAL</button>
    </div>
</form>
      </div>
    </div>
