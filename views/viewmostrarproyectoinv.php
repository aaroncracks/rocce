...
<div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="m-4 mb-5">
                <a href="index.php?accion=viewaltaproyecto" class="btn btn-primary w-40 left--1-m">Crear proyecto</a>
                <a href="index.php?accion=viewaddproyectoinv" class="btn btn-primary w-40 left--1-m">Añadir proyecto</a>
            </div>
