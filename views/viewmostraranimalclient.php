...
<?php if (isset($_GET['msg'])){ 
    ...
    <form class="row g-3 mt-5 mb-2 ml-5" method="POST" action="index.php?accion=viewanimalclient">
        <div class="col-md-2">
        ...
        <div class="container pt-5 pb-3">
            <div class="row">
                ...
                <?php } 
                    if(count($datos) == 0){
                ?>
                    <span class="h5 text-decoration-none text-danger">NO HAY ANIMALES</span>
                <?php
                    }
                ?>
                 ...
                 <?php if($pag<1){ ?>
        <a href="index.php?accion=viewanimalclient&pag=<?= $pag - 1 ?>" class="btn btn-primary w-40 left--1-m">Anterior</a>
        <?php }else{ ?>
            <a href="index.php?accion=viewanimalclient&pag=<?= 1 ?>" class="btn btn-primary w-40 left--1-m">Anterior</a>
            <?php } ?>
        <?php if($pag>$total){ ?>
        <a href="index.php?accion=viewanimalclient&pag=<?= $pag + 1 ?>" class="btn btn-primary w-40 left--1-m">Despues</a>
        <?php }else{ ?>
            <a href="index.php?accion=viewanimalclient&pag=<?= $total ?>" class="btn btn-primary w-40 left--1-m">Despues</a>
            <?php } ?>
            </div>
        </div>
    </div>
