                ...
                ?>
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="package-item bg-white mb-2">
                                    ...
                                    <a class="h5 text-decoration-none" href=""><?php echo $dato["titulo"]; ?></a>
                                    <a href="index.php?accion=addproyecto&id=<?= $dato['id'] ?>" class="btn btn-primary ml-5 w-40 left--1-m">Añadir</a>
                                    </div>
