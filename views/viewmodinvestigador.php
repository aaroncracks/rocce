...
?>
<h2>MODIFICAR INVESTIGADOR - <?php echo $dato["nombre"] ?></h2><br>
<form <?php echo 'action="index.php?accion=modinvestigador&id='.$dato["id"].'"'; ?>  method="post" enctype="multipart/form-data">
    ...
    <div class="control-group">
        <select name="especialidad" class="form-control">
                <option value="Biologos" <?php if($dato["especialidad"]=="Biologos"){ echo "selected"; } ?>>Biologos</option>
                <option value="Ecologos" <?php if($dato["especialidad"]=="Ecologos"){ echo "selected"; } ?>>Ecologos</option>
                <option value="Geólogos" <?php if($dato["especialidad"]=="Geólogos"){ echo "selected"; } ?>>Geólogos</option>
                <option value="Sociólogos" <?php if($dato["especialidad"]=="Sociólogos"){ echo "selected"; } ?>>Sociólogos</option>
        </select>
        <p class="help-block text-danger"></p>
    </div>
