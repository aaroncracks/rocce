...
<?php include ('controller/header.php'); ?>
    ...
    <h2 class="mb-4 text-center">Alta Planta</h2>
<div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
           <form action="index.php?accion=altaplanta"  method="post" enctype="multipart/form-data">
        ...
        <div class="control-group">
            ...
            <input type="text" class="form-control p-4" name="ciclo" placeholder="ciclo"
                required="required" data-validation-required-message="Por favor escriba el nombre" />
            <p class="help-block text-danger"></p>
        </div>
        <div class="control-group">
            <label for="">TALLO</label>
            <input type="text" class="form-control p-4" name="tallo" placeholder="tallo"
                required="required" data-validation-required-message="Por favor escriba el nombre" />
            <p class="help-block text-danger"></p>
        </div>
        <div class="control-group">
        ...
        <div class="text-center">
            <button class="btn btn-primary py-3 px-4" type="submit" id="sendMessageButton">CREAR PLANTA</button>
        </div>
    </form>
      </div>
    </div>
