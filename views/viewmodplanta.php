...
<form <?php echo 'action="index.php?accion=modplanta&id='.$dato["id"].'"'; ?>  method="post" enctype="multipart/form-data">
    ...
    <div class="control-group">
        <input type="text" class="form-control p-4" name="ciclo" placeholder="Nombre" <?php echo 'value="'.$dato["ciclo"].'"'; ?>
            required="required" data-validation-required-message="Por favor escriba el nombre" />
        <p class="help-block text-danger"></p>
    </div>
    <div class="control-group">
        <input type="text" class="form-control p-4" name="tallo" placeholder="Nombre" <?php echo 'value="'.$dato["tallo"].'"'; ?>
            required="required" data-validation-required-message="Por favor escriba el nombre" />
        <p class="help-block text-danger"></p>
    </div>
    <div class="control-group">
